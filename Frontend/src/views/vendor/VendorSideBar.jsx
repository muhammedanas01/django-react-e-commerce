    ...
    return (
        <div className="col-md-3 col-lg-2 sidebar-offcanvas bg-dark navbar-dark" id="sidebar" role="navigation">
            <ul className="nav nav-pills flex-column mb-auto nav flex-column pl-1 pt-2">
                ...
                <li className="mb-3">
                    <Link to="/vendor/review/" className={isActiveLink(location.pathname, '/vendor/reviews/') ? "nav-link text-white active" : "nav-link text-white"}>
                        <i className="bi bi-star" /> Reviews{" "}
                    </Link>
                </li>
                <li className="mb-3">
                    <Link to="/vendor/add-new-product/" className={isActiveLink(location.pathname, '/vendor/product/new/') ? "nav-link text-white active" : "nav-link text-white"}>
